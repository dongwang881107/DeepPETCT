...
class M3SNET(nn.Module):
    ...
    def __init__(self):
        ...
        # attention blocks
        self.sa_ct = atten_block(self.out_channel)
        self.sa_pet = atten_block(self.out_channel)
        self.sa_com1 = atten_block(self.out_channel*2)
        self.sa_com2 = atten_block(self.out_channel)
