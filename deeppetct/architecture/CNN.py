...
class UNET_RADIOLOGY(nn.Module):
    def __init__(self):
        ...
        self.layer4 = conv_block('conv', 16, 32, self.kernel_size, 1, self.padding, self.acti, self.bn_flag)
        ...
        self.layer7 = conv_block('conv', 32, 64, self.kernel_size, 1, self.padding, self.acti, self.bn_flag)
        self.layer8 = conv_block('conv', 64, 64, self.kernel_size, 1, self.padding, self.acti, self.bn_flag)
        self.layer9 = down_sampling('maxpooling', kernel_size=2, stride=2, padding=0)
        self.layer10 = conv_block('conv', 64, 128, self.kernel_size, 1, self.padding, self.acti, self.bn_flag)
