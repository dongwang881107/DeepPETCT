...
def main(args):
    ...
    loss_weights = [1,0.1]
    loss_modalities = ['PET','PET','CT']
    loss_func = LossCompose([MSELoss(), aSPLoss()], loss_weights, loss_modalities)
...
if __name__ == "__main__":
    ...
    subparser_train.add_argument('--lr', type=float, default=1e-5, help='learning rate of model')
